...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    [self.Buble_image setFrame:CGRectMake(self.frame.size.width - 128, self.Buble_image.frame.origin.y, self.Buble_image.frame.size.width, self.Buble_image.frame.size.height)];
    self.Buble_image.autoresizingMask = UIViewAutoresizingFlexibleRightMargin |
