...
static NSTimeInterval defaultTimeOutSeconds = 2000;
...
- (id)initWithURL:(NSURL *)newURL
{
	...
	[self setPersistentConnectionTimeoutSeconds:2000];
    ...
    /*//Staging k liye certificate validate karna hai & Prod k liye nahi karna hai
    if ([PRODUCTION_BASE_URL rangeOfString:@"staging.ufony.com"].location != NSNotFound) {
